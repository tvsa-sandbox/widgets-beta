...
const Placeholder = props => {
    ...
    if (ui === "pleyers") {
        return (
            <PlaceholderStyles ratio={ratio} {...props}>
                <IconsStyles name="LosPleyers" size={size} variant="Transparent" />
                {children}
            </PlaceholderStyles>
        );
    }
    if (ui === "videodigital") {
        return (
            <PlaceholderStyles ratio={ratio} {...props}>
                <IconsStyles name="VideoTelevisaFull" size={80} variant="Transparent" />
                {children}
            </PlaceholderStyles>
        );
    }
    ...
    if (ui === "televisanews") {
        return (
            <PlaceholderStyles ratio={ratio} {...props}>
                <IconsStyles name="News" size={size} variant="Transparent" />
                {children}
            </PlaceholderStyles>
        );
    }
    if (ui === "slang") {
        return (
            <PlaceholderStyles ratio={ratio} {...props}>
                <IconsStyles name="Slang" size={size} variant="Transparent" />
                {children}
            </PlaceholderStyles>
        );
    }
    if (ui === "televisacom") {
        return (
            <PlaceholderStyles ratio={ratio} {...props}>
                <IconsStyles name="Logo" size={size} variant="Transparent" />
                {children}
            </PlaceholderStyles>
        );
    }
    if (ui === "whitelabel") {
        return (
            <PlaceholderStyles ratio={ratio} {...props}>
                <IconsStyles name="WhiteLabel" size={size} variant="Transparent" />
                {children}
            </PlaceholderStyles>
        );
    }
