...
const ChapterItemTextStyles = styled(Text)(
    ({ theme }) => css`
        ...
        color: ${theme.colors.gray3};
        display: block;
        margin: ${theme.space.zero} ${theme.space.lg} ${theme.space.xxl};

        @media (min-width: ${theme.breakpoints.xl}) {
            margin: ${theme.space.zero} ${theme.space.md} ${theme.space.xl} ${theme.space.base};
        }
    `,
);
...
const ChapterItemBoxTop = styled(Box)(
    ({ theme }) => css`
        margin: ${theme.space.md} ${theme.space.zero} ${theme.space.md};
        min-height: 25px;
        display: grid;
        grid-gap: 2px;
