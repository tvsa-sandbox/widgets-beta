...
const Article = ({ author, date, description, lead, title }) => {
    return (
        <ArticleStyles>
            <ArticleBoxStyles>
                <ArticleBoxLeftStyles variant="Responsive">
                    <ArticleImageStyles ratio="aspect9x16" variant="Transparent" src={lead} />
                </ArticleBoxLeftStyles>
                <ArticleBoxIconStyles variant="Responsive">
                    <ArticleIconStyles name="Facebook" />
                    <ArticleIconStyles name="Twitter" />
                    <ArticleIconStyles name="Instagram" />
                </ArticleBoxIconStyles>
                <ArticleRightStyles variant="Responsive">
                    <ArticleTitleStyles variant="h2">{title}</ArticleTitleStyles>
                    <ArticleDescriptionStyles>{description}</ArticleDescriptionStyles>
                    <ArticleInfoStyles variant="Transparent">
                        <ArticleTimeStyles variant="Airtime">{date}</ArticleTimeStyles>
                        <ArticleCreditStyles>{author}</ArticleCreditStyles>
                    </ArticleInfoStyles>
                    <ArticleTextBodyStyles>
                        ...
                        velit cursus nunc, Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
