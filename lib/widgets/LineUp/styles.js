...
const LineUpTitle = styled(Title)(
    ({ theme }) => css`
        width: 100%;
...
export { LineUpStyles, LineUpTitle, LineUpPlayerField, LineUpBoxField, LineUpNameField, LineUpBoxHome, LineUpBoxAway, LineUpBoxPlayer, LineUpContainer, LineUpNumberHome, LineUpNumberAway, LineUpName, LineUpIcons, LineUpBoxName, LineUpGridField, LineUpBoxHomeTeam, LineUpBoxAwayTeam };
