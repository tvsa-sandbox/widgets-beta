            ...
            <Box variant="Flex">
                <EndCardImageBox>
                    <EndCardControls>
                        ...
                        <EndCardPause icon="Video" variant="Transparent" aria-label="pause" />
                    </EndCardControls>
                ...
                <EndCardTitleBox variant="Transparent">
                    ...
                    <EndCardBoxControls variant="Flex">
                        <EndCardButton icon="Replay" variant="Transparent" aria-label="replay">
                            <ButtonText>{replayCopy}</ButtonText>
                        </EndCardButton>
                    </EndCardBoxControls>
                </EndCardTitleBox>
            </Box>
