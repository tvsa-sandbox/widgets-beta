...
const HighImpactFull_SliderItem = () => (
    <div className="HighImpact__SliderThumbContainer WhiteLabel" id="swipe">
        <div className="HighImpact__SliderItem WhiteLabel">
            <div className="HighImpact__SliderItemThumbnail WhiteLabel">
                ...
                <div className="HighImpact__SliderItemVideoContainer WhiteLabel">
                    <div className="HighImpact__SliderItemVideo WhiteLabel">
                        AQUI VA UN VIDE0
                    </div>
                </div>
                <div className="HighImpact__SliderItemIconContainer WhiteLabel">
                    <div className="HighImpact__SliderItemIcon Icn_Video WhiteLabel">
                        <span className="Display">
                            Icono de Play
                        </span>
                    </div>
                </div>
                <div className="HighImpact__SliderItemInfoContainer WhiteLabel">
                    <div className="HighImpact__SliderItemDuration WhiteLabel">
                        <span>
                            04:15
                        </span>
                    </div>
                ...
                <Link to="/" className="HighImpact__SliderItemCaptionAnchor WhiteLabel">
                    <div className="HighImpact__SliderItemTitleContainer WhiteLabel">
                        <h3 className="HighImpact__SliderItemTitle WhiteLabel">
                            Mandzukic marca el gol de la ventaja en tiempo
                            extra,Francia-Croacia Final Rusia
                        </h3>
                    </div>
