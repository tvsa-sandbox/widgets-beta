...
const Mosaic = () => (
    <section className="Mosaic WhiteLabel">
        <div className="Mosaic__TitleContainer WhiteLabel">
            <h2 className="Mosaic__Title WhiteLabel">
                Título Mosaic
            </h2>
        </div>
        ...
        <div className="Mosaic__ButtonContainer WhiteLabel">
			<button className="Mosaic__Button WhiteLabel">
					Ver más
			</button>
		</div>
    </section>
