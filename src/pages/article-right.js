...
const ArticleRight = () => (
  ...
  <Layout>
    <h1 style={{color: "#FFF", textAlign:"center", margin:"30px", fontSize:"50px", fontFamily:"sans-serif"}}>Article Right</h1>
                ...
                <div className="ArticleRight__Container WhiteLabel">
                            ...
                            <div className="ArticleRight__InfoContainer WhiteLabel">
                                <div className="ArticleRight__ShareContainer WhiteLabel">
                                    <div className="ArticleRight__Share WhiteLabel">
                                        <a className="ArticleRight__ShareIcon Icn_Facebook WhiteLabel" href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" title=""><p className="Display">facebook</p></a>
                                        <a className="ArticleRight__ShareIcon Icn_Twitter WhiteLabel" href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" title=""><p className="Display">twitter</p></a>
                                        <a className="ArticleRight__ShareIcon Icn_Instagram WhiteLabel" href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" title=""><p className="Display">instagram</p></a>
                                    </div>
                                </div>
                    ...
                    <aside className="ArticleRight__RightContent WhiteLabel">
                        <div className="ArticleRight__Text WhiteLabel">
                            ...
                            <div>
                                <iframe width="560" height="315" title="Video Youtube" src="https://www.youtube.com/embed/r8TV3bPZWCc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>
                            <p>Gal Gadot is an Israeli actress, singer, martial artist, and model. She was born in Rosh Ha'ayin, Israel, to a Jewish family. Her parents are Irit, a teacher, and Michael, an engineer, who is a sixth-generation Israeli. She served in the IDF for two years, and won the Miss Israel title in 2004.</p>
                            <p><img className="image_prueba" src="https://www.alternativo.mx/wp-content/uploads/2017/05/wm-701x394.jpg" alt="Italian Trulli" /></p>
