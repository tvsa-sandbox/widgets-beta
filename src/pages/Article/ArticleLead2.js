...
import LeadSlideShowSliderItem from "../../leads/LeadSlideShow/LeadSlideShow_SliderItem/LeadSlideShow_SliderItem";
...
const Article = () => (
    <section className="Page">
        ...
        <section className="PageContent__Lead WhiteLabel">
            <div className="Lead WhiteLabel">
                <div className="LeadSlideShow WhiteLabel">
                        <LeadSlideShowSliderItem />
                </div>
            </div>
        </section>
