...
// import LeadImage from "../../leads/LeadImage";
...
const Article = () => (
    <section className="Page">
        ...
        <section className="PageContent__Lead WhiteLabel">
            <div className="lead">
                <div className="LeadImage WhiteLabel">
                    <div className="LeadImage__PictureContainer WhiteLabel">
                        <picture>
                            <source media="(min-width: 0px) and (max-width: 414px)" srcSet={withPrefix("/static/aspect-ratio-images/4x3-818x614.jpg")} />
                            ...
                            <img alt="test" className="LeadImage__Picture WhiteLabel" src={withPrefix("/static/aspect-ratio-images/40x17-1440x612.jpg")} />
                        </picture>
                    </div>
                    <div className="LeadImage__InfoContainer WhiteLabel">
                        <div className="LeadImage__DescriptionContainer WhiteLabel">
                            <h3 className="LeadImage__Description WhiteLabel">
                                Carlos Rivera llega como coach de La Voz México y aquí te decimos 6 datos curiosos
                            </h3>
                        </div>
                        <div className="LeadImage__TextContainer WhiteLabel">
                            <small className="LeadImage__Text WhiteLabel">
                                Instagram
                            </small>
                        </div>
                    </div>
                    ...
                    <div className="Article__CreditsContainer WhiteLabel">
                        ...
                        <div className="Article__ShareBar WhiteLabel">
                            <div className="Article__ShareBarDesktop WhiteLabel">
                                <a className="Article__ShareBarLink Icn_Facebook WhiteLabel" href="https://www.facebook.com/GameTimeOf/" target="_blank" rel="noopener noreferrer" title="">
                                    <p className="Display">
                                        facebook
                                    </p>
                                </a>
                                <a className="Article__ShareBarLink Icn_Instagram WhiteLabel" href="https://www.instagram.com/gametimeof/"  target="_blank" rel="noopener noreferrer" title="">
                                    <p className="Display">
                                        instagram
                                    </p>
                                </a>
                                <a className="Article__ShareBarLink Icn_Twitter WhiteLabel" href="https://twitter.com/@GameTimeOf" target="_blank" rel="noopener noreferrer" title="">
                                    <p className="Display">
                                        twitter
                                    </p>
                                </a>
